    ...
    <footer className={styles.footer}>
        ...
        <div className={styles.contactItem}>
          ...
          <h3 className={styles.sectionTitle}>
            ...
            <p>
              ...
              cc@uppist.xyz
              <br />
              <span className={styles.contactLabel}>Phone: </span> (+234)
              9132035923
            </p>
          </h3>
        </div>
      ...
      <div className={styles.footerContent}>
        ...
        <div className={styles.footerSection}>
          ...
          <div className={styles.sectionQuickLinks}>
            ...
            <p>
              <Link to='/services/creative'>Creative & Digital Marketing</Link>
            </p>
            <p>
              <Link to='/services/creative'>Technology Solutions</Link>
            </p>
            <p>
      ...
      <div className={styles.socialSection}>
        ...
        <div className={styles.socialIcons}>
          <a
            href='https://www.facebook.com/share/1CKYwPdxKs/?mibextid=wwXIfr'
            target='_blank'
          ...
          <a
            href='https://www.instagram.com/uppisthq?igsh=MWtlanFkYjhkajI1Ng=='
            target='_blank'
            rel='noopener noreferrer'
          >
          ...
          <a
            href='https://x.com/uppisthq?s=21'
            target='_blank'
            rel='noopener noreferrer'
          >
          ...
          <a
            href='https://www.linkedin.com/company/uppisthq/people/?viewAsMember=true'
            target='_blank'
            rel='noopener noreferrer'
          >
            <img
