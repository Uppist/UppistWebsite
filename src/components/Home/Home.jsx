    ...
    <>
        ...
        <div className={styles.content}>
          <h1>
            ...
            <span className={styles.highlight}>
              Digital{" "}
              <span className={styles.desktopHighlight}> Marketing, </span>{" "}
            ...
            <span className={styles.desktopHighlight}>and</span>{" "}
            <span className={styles.mobileHighlight}>
              {" "}
              <br /> and
            </span>{" "}
          ...
          <p>
            Our expert services in digital marketing, brand identity design and
            technology development help position you as an authority in your
            industry, attract the right audience, and generate high-quality
            leads.
          </p>
      ...
      <section className={styles.people}>
        ...
        <div className={styles.peopleContent}>
          ...
          <p className={styles.peopleText}>
            Uppist is a forward-thinking firm committed to helping brands
            succeed in today's digital-first world. <br /> <br />
            Through our offerings in creative and digital marketing, as well as
            technology development, we enable businesses in Nigeria and beyond
            unlock new
          </p>{" "}
          <br />
          <button
            className={styles.peopleCta}
        ...
        <div className={styles.missionContent}>
          <div className={styles.missionColumn}>
            ...
            <p className={styles.missionText}>
              ...
              We aim to empower people and businesses to do more, achieve more,
              and grow beyond limits. <br /> <br />
              By combining expert professional services with innovative
              technology, we help unlock new opportunities and transform
              everyday digital challenges into success.
            </p>
          </div>
          <div className={styles.missionColumn}>
      ...
      <section className={styles.services}>
        ...
        <p className={styles.servicesText}>
          Uppist combines creativity and technology to offer a full range of
          digital services that help businesses in Nigeria and beyond to
          compete, scale, and thrive.
        </p>
          ...
          <div className={styles.servicesContainer2}>
            <div className={styles.serviceBox2}>
              <div className={styles.servicesCard2}>
                ...
                <p className={styles.servicesCardText}>
                  Beyond marketing, we deliver custom technology solutions that
                  help businesses become more efficient, scalable, and
                  innovative.
                </p>
                <button
                  className={styles.servicesCardButton}
            ...
            <img
              ...
              className={styles.servicesImage2}
            />
          </div>
        </div>
      </section>
        ...
        <div className={styles.chooseContainer}>
          <div className={styles.chooseContent}>
            ...
            <p className={styles.chooseText}>
              We combine the creativity and storytelling strength of digital
              marketing with the technical depth and precision of our
              technological expertise. This unique blend means Uppist can help
              your business do more than just exist online: we help you craft a
              brand that resonates, build digital products that scale, and
              implement strategies that deliver measurable growth.
              <br />
              <br />
              Whether you’re a startup looking to launch your first product, an
              SME aiming to increase visibility and engagement, or an
              established enterprise ready to embrace digital transformation,
              Uppist is here to guide and build with you, turning your ideas
              into powerful, scalable solutions that keep you competitive in
